...
if type(AddonTable.defaultTextColorTable) ~= "table" then
	AddonTable.defaultTextColorTable = {}
end
local TextColorTable = AddonTable.defaultTextColorTable
...
for x = 1, #temp do
	ColorTable[temp[x]] = WoWFuncColor
end
temp = nil
...
for x = 1, #temp do
	TextColorTable[temp[x]] = eventColor
end
temp = nil
